package com.example.encodelibso;

import com.example.encodelibso.ElfType32.Elf32_Sym;
import com.example.encodelibso.ElfType32.elf32_phdr;
import com.example.encodelibso.ElfType32.elf32_shdr;
...
public class EncodeSection {
	...
	public static void main(String[] args){
		...
		byte[] fileByteArys = Utils.readFile("needencry_so/libapplication.so");
		...
		Utils.saveFile("needencry_so/libapplication_enc.so", fileByteArys);
